...
func (this ActivityStreamsSharedInboxProperty) GetActivityStreamsOrderedCollection() vocab.ActivityStreamsOrderedCollection {
...
func (this ActivityStreamsSharedInboxProperty) GetActivityStreamsOrderedCollectionPage() vocab.ActivityStreamsOrderedCollectionPage {
...
func (this ActivityStreamsSharedInboxProperty) GetType() vocab.Type {
...
// property.
func (this ActivityStreamsSharedInboxProperty) IsActivityStreamsOrderedCollection() bool {
...
// property.
func (this ActivityStreamsSharedInboxProperty) IsActivityStreamsOrderedCollectionPage() bool {
...
func (this *ActivityStreamsSharedInboxProperty) SetActivityStreamsOrderedCollection(v vocab.ActivityStreamsOrderedCollection) {
	this.Clear()
...
func (this *ActivityStreamsSharedInboxProperty) SetActivityStreamsOrderedCollectionPage(v vocab.ActivityStreamsOrderedCollectionPage) {
	this.Clear()
...
func (this *ActivityStreamsSharedInboxProperty) SetType(t vocab.Type) error {
	...
	return fmt.Errorf("illegal type to set on sharedInbox property: %T", t)
}
